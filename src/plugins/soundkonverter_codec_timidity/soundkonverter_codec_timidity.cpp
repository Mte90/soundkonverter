...
int soundkonverter_codec_timidity::convert( const QUrl& inputFile, const QUrl& outputFile, const QString& inputCodec, const QString& outputCodec, const ConversionOptions *_conversionOptions, TagData *tags, bool replayGain )
{
...
QStringList soundkonverter_codec_timidity::convertCommand( const QUrl& inputFile, const QUrl& outputFile, const QString& inputCodec, const QString& outputCodec, const ConversionOptions *_conversionOptions, TagData *tags, bool replayGain )
{
    Q_UNUSED(inputCodec)
...
K_PLUGIN_CLASS_WITH_JSON(soundkonverter_codec_timidity, "codec_timidity.json")
