    ...
    config( _config )
{
    ...
    grid->setContentsMargins( fontHeight, fontHeight, fontHeight, fontHeight );
...
void OptionsSimple::profileRemove()
{
    ...
    const int ret = QMessageBox::question( this, i18n("Do you really want to remove the profile: %1",profileName), i18n("Remove profile?") );
...
void OptionsSimple::formatInfo()
{
    ...
    {
        QMessageBox::information( this, i18n("Format Info"), i18n("Sorry, no format information available.") );
    }
}
...
void OptionsSimple::profileChanged()
{
    ...
    {
        for(const QString& profileName : config->data.profiles.keys())
        {
